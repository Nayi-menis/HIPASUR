...
@section('content')
  <div class="row">
    <h1> Registro de un nuevo Trabajador</h1>
  </div>
  ...
  <div class="row">
    <div class="col-md-16">
        <div class="card card-outline card-primary">
          ...
          <div class="card-body">
            <form action="{{url('/admin/recursos/create')}}" method="POST">
                @csrf
                <div class="row">
                  <div class="col-md-4">
                  ...
                  <div class="col-md-4">
                    <div class="from group">
                      ...
                      <input type="text" value="{{old('edad')}}" name="edad" class="form-control" required>
                      @error('edad')
                      <small style="color: red">{{$message}}</small>
                      @enderror
                    </div>
                ...
                <div class="row">
                  <div class="col-md-4">
                    <div class="from group">
                      ...
                      <input type="text" value="{{old('cuenta')}}" name="cuenta" class="form-control" required>
                      @error('cuenta')
                      <small style="color: red">{{$message}}</small>
                      @enderror
                    </div>
                  ...
                  <div class="col-md-4">
                    <div class="from group">
                      ...
                      <input type="unique" value="{{old('stc')}}" name="stc" class="form-control" required>
                      @error('stc')
                      <small style="color: red">{{$message}}</small>
                      @enderror
                    </div>
                ...
                <div class="row">
                  <div class="col-md-4">
                    <div class="from group">
                      ...
                      <input type="address" value="{{old('departamento')}}" name="departamento" class="form-control" required>
                      @error('departamento')
                      <small style="color: red">{{$message}}</small>
                      @enderror
                    </div>
                  ...
                  <div class="col-md-4">
                    <div class="from group">
                      ...
                      <input type="address" value="{{old('provincia')}}" name="provincia" class="form-control" required>
                      @error('provincia')
                      <small style="color: red">{{$message}}</small>
                      @enderror
                    </div>
